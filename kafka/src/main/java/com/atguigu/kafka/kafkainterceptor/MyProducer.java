...
//        对key和value进行序列化操作
        ...
        inters.add("com.atguigu.kafka.kafkainterceptor.NumInterception");
        inters.add("com.atguigu.kafka.kafkainterceptor.CountInterceptor");
        props.put(ProducerConfig.INTERCEPTOR_CLASSES_CONFIG,inters);
